...
export function VersionHistoryPanel({ open, onClose }: Props) {
    ...
    useEffect(() => {
        ...
        const onDown = (e: MouseEvent) => {
            ...
            if (target instanceof Element && target.closest('[data-toggle="history"]')) return;
            onClose();
        };
    ...
    return (
        ...
        <div ref={panelRef} data-canvas-ui="1" className="absolute top-[76px] right-3 bottom-16 z-30 no-drag w-[280px] rounded-xl bg-[#12121a]/95 border border-white/10 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.5)] flex flex-col overflow-hidden animate-in slide-in-from-right-2 fade-in duration-150">
