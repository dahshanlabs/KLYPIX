// ============================================================
// intentEngine.ts  —  Project Eye / Klypix
...
You are an intent classifier for a desktop AI assistant called Eye (Klypix).
...
────────────────────────────────────────────────
  ...
  system_close      — "close X", "kill X", "exit X", "quit X"
...
const VALID_INTENT_TYPES: IntentType[] = [
  ...
  'system_open', 'system_type', 'system_click', 'system_screenshot', 'system_close',
  'chat',
];
