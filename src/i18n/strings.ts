...
const strings: Strings = {
    ...
    'settings.tab.canvas': { en: 'Canvas', ar: 'اللوحة' },
    'settings.vault.caption': { en: 'Choose the folder your .klypix canvases live in. Open & Save dialogs start here. Leave unset to use your last-used location.', ar: 'اختر المجلد الذي تحفظ فيه لوحات ‎.klypix. تبدأ نوافذ الفتح والحفظ من هنا. اتركه فارغًا لاستخدام آخر موقع استخدمته.' },
    'settings.vault.folder': { en: 'Vault folder', ar: 'مجلد اللوحات' },
    'settings.vault.unset': { en: 'Not set — dialogs open in your last-used location', ar: 'غير محدّد — تُفتح النوافذ في آخر موقع استخدمته' },
    'settings.vault.choose': { en: 'Choose folder', ar: 'اختيار مجلد' },
    'settings.vault.open': { en: 'Open folder', ar: 'فتح المجلد' },
    'settings.vault.reset': { en: 'Reset', ar: 'إعادة تعيين' },
