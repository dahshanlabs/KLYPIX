...
const strings: Strings = {
    ...
    'offline.title': { en: 'Offline models', ar: 'النماذج دون اتصال' },
    'offline.caption': { en: 'On-device OCR and transcription — one click to install, no terminal setup. Nothing is bundled; models download on demand. Cloud (Gemini) stays the default and fallback.', ar: 'تعرّف ضوئي ونسخ صوتي على الجهاز — تثبيت بنقرة واحدة، دون إعداد طرفية. لا شيء مُضمّن؛ تُنزَّل النماذج عند الطلب. تبقى السحابة (Gemini) الافتراضية والبديل.' },
    'offline.prefer': { en: 'Prefer offline when a model is installed', ar: 'تفضيل العمل دون اتصال عند تثبيت نموذج' },
    'offline.ocr_group': { en: 'Read text from images & scanned PDFs', ar: 'قراءة النص من الصور وملفات PDF الممسوحة' },
    'offline.stt_group': { en: 'Transcribe audio & video on-device', ar: 'نسخ الصوت والفيديو على الجهاز' },
    ...
    'canvas.brain.health': { en: 'Brain health', ar: 'صحة الدماغ' },
    'canvas.brain.connect': { en: 'Connect {n} related', ar: 'اربط {n} مترابطة' },
    'canvas.brain.connectable': { en: '{n} related, unlinked', ar: '{n} مترابطة وغير موصولة' },
    'canvas.brain.orphans': { en: '{n} unlinked', ar: '{n} غير موصولة' },
    'canvas.brain.unlinked': { en: 'unlinked', ar: 'غير موصولة' },
    'canvas.brain.stale': { en: '{n} stale question(s)', ar: '{n} سؤال قديم' },
    'canvas.brain.stale_short': { en: 'stale', ar: 'قديمة' },
    'canvas.brain.hubs': { en: 'hubs', ar: 'محاور' },
    'canvas.brain.hubs_hint': { en: 'Most-connected, load-bearing cards', ar: 'البطاقات الأكثر اتصالاً والأكثر أهمية' },
    'canvas.brain.jump_hint': { en: 'Click to jump to this card', ar: 'انقر للانتقال إلى هذه البطاقة' },
    'canvas.brain.semantic_hint': { en: 'In-app linking uses shared tags & [[mentions]]. For semantic links across topics, ask your agent to run brain_connect.', ar: 'الربط داخل التطبيق يستخدم الوسوم المشتركة و[[الإشارات]]. للربط الدلالي عبر المواضيع، اطلب من وكيلك تشغيل brain_connect.' },
    'canvas.brain.connected': { en: '🔗 Linked {n} related cards by shared tags & mentions. Ctrl+Z undoes.', ar: '🔗 تم ربط {n} بطاقة مترابطة عبر الوسوم والإشارات. Ctrl+Z للتراجع.' },
    'canvas.brain.no_structural': { en: 'No shared-tag / [[mention]] links to draw. For semantic linking across topics, ask your agent to run brain_connect.', ar: 'لا توجد روابط وسوم/[[إشارات]] للرسم. للربط الدلالي عبر المواضيع، اطلب من وكيلك تشغيل brain_connect.' },
    ...
    'canvas.connect.placeholder': { en: 'type a name…', ar: 'اكتب اسمًا…' },
    'canvas.connect.empty': { en: 'No matching cards', ar: 'لا توجد بطاقات مطابقة' },
    'canvas.connect.hint': { en: 'or click a card on the canvas', ar: 'أو انقر بطاقة على اللوحة' },
    ...
    // {t} is a pre-formatted relative time ("4d ago" / "قبل ٤ ي").
    'canvas.joined': { en: 'joined {t}', ar: 'انضممت {t}' },
    'canvas.role_editor': { en: 'editor', ar: 'محرّر' },
    'canvas.role_owner': { en: 'owner', ar: 'المالك' },
    'canvas.shared_by_you': { en: 'Shared by you', ar: 'مشاركة منك' },
    'canvas.last_shared': { en: 'last shared {t}', ar: 'آخر مشاركة {t}' },
    'canvas.someone': { en: 'Someone', ar: 'أحدهم' },
    'canvas.expires_in_days': { en: 'expires in {n}d', ar: 'تنتهي خلال {n} ي' },
    'canvas.expires_in_hours': { en: 'expires in {n}h', ar: 'تنتهي خلال {n} س' },
    'canvas.expires_soon': { en: 'expires soon', ar: 'تنتهي قريبًا' },
    'canvas.expired': { en: 'expired', ar: 'منتهية' },
    'canvas.unknown_date': { en: 'unknown date', ar: 'تاريخ غير معروف' },
    'canvas.no_key': { en: 'no key', ar: 'بلا مفتاح' },
    'canvas.open_shared': { en: 'Open shared canvas', ar: 'فتح اللوحة المشتركة' },
    // {t} is a locale-formatted absolute date (the canvas's last-updated time).
    'canvas.open_shared_updated': { en: 'Open shared canvas · last updated {t}', ar: 'فتح اللوحة المشتركة · آخر تحديث {t}' },
    'canvas.leave_shared': { en: 'Leave shared canvas', ar: 'مغادرة اللوحة المشتركة' },
    'canvas.invitation_too_old': { en: 'This invitation was sent before key-sharing landed. Ask the owner for a fresh invite.', ar: 'أُرسِلت هذه الدعوة قبل دعم مشاركة المفاتيح. اطلب من المالك دعوة جديدة.' },
    // {r} is a (usually technical, English) failure reason from the backend.
    'canvas.open_shared_failed': { en: "Couldn't open shared canvas: {r}", ar: 'تعذّر فتح اللوحة المشتركة: {r}' },
    ...
    'toolbar.pan': { en: 'Pan (H, or hold Space)', ar: 'تحريك (H، أو اضغط مع الاستمرار على Space)' },
    ...
    'canvas.wikilink.open': { en: 'Open card', ar: 'فتح البطاقة' },
    'canvas.wikilink.unlink': { en: 'Unlink (keep text)', ar: 'إلغاء الربط (إبقاء النص)' },
    'canvas.wikilink.remove': { en: 'Remove link', ar: 'إزالة الرابط' },
    'canvas.wikilink.chip_tip': { en: 'Open "{title}" · right-click for options', ar: 'فتح "{title}" · زر الفأرة الأيمن للخيارات' },
    ...
    'canvas.command_bar.stop': { en: 'Stop agent', ar: 'إيقاف الوكيل' },
    'canvas.command_bar.stopping': { en: 'Stopping agent…', ar: 'جارٍ إيقاف الوكيل…' },
    'canvas.command_bar.stopped': { en: 'Agent stopped', ar: 'تم إيقاف الوكيل' },
    'canvas.command_bar.minimize': { en: 'Minimize — keep running', ar: 'تصغير — يستمر العمل' },
    'canvas.command_bar.restore': { en: 'Show agent', ar: 'إظهار الوكيل' },
    ...
    'palette.clip_sort.newest': { en: 'Newest first', ar: 'الأحدث أولاً' },
    'palette.clip_sort.oldest': { en: 'Oldest first', ar: 'الأقدم أولاً' },
    'palette.clip_sort.hint': { en: 'Toggle sort order — newest ↔ oldest', ar: 'تبديل ترتيب الفرز — الأحدث ↔ الأقدم' },
    ...
    'canvas.zoom_in': { en: 'Zoom in (Ctrl+=)', ar: 'تكبير (Ctrl+=)' },
    'canvas.zoom_out': { en: 'Zoom out (Ctrl+-)', ar: 'تصغير (Ctrl+-)' },
    ...
    'status.pan_tool': { en: 'pan', ar: 'تحريك' },
