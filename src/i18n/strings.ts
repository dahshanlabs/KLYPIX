...
const strings: Strings = {
    ...
    'offline.caption': { en: 'Optional on-device OCR and transcription. Nothing is bundled — models download on demand. Cloud (Gemini) stays the default and the fallback.', ar: 'تعرّف ضوئي ونسخ صوتي على الجهاز (اختياري). لا شيء مُضمّن — تُنزَّل النماذج عند الطلب. تبقى السحابة (Gemini) الافتراضية والبديل.' },
    ...
    'offline.stt_group': { en: 'Transcribe voice notes & audio (on-device)', ar: 'نسخ الملاحظات الصوتية والصوت (على الجهاز)' },
    'offline.stt_note': { en: 'Whisper runs in-app (no GPU required). Video keeps using cloud for on-screen visuals.', ar: 'يعمل Whisper داخل التطبيق (بدون الحاجة لمعالج رسومات). يبقى الفيديو يستخدم السحابة للعناصر المرئية.' },
